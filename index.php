    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.php">LearnMore</a></div>
          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                ...
                <li><a href="#programs-section" class="nav-link">Info</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="teacher text-center">
              <img src="Shradha.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">Shradha Khapra </h3>
                <p class="position">JAVA Teacher</p>
                <p>Made over 100 websites with years of experience, taught over 1000 students.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="teacher text-center">
              <img src="mosh.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">Mosh Hamedani</h3>
                <p class="position">PYTHON Teacher</p>
                <p>Over 20 years of experience Python and successfully completed many projects .</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="teacher text-center">
              <img src="https://yt3.googleusercontent.com/ytc/AGIKgqM-3SNx8a5RCmp723MtJ7shupUHHe5WX1lt2pTx8w=s176-c-k-c0x00ffffff-no-rj" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">Alex lee</h3>
                <p class="position">Java Basics</p>
                <p>Leading expert in the domain of JAVA, taught many students over the years.</p>
              </div>
            </div>
          </div>
        </div>
